...
- All required docs (`RESEARCH.md`, `PLAN.md`, `ARCHITECTURE.md`, `README.md`, `DESIGN.md`, `AI_USAGE.md`, `HANDOVER.md`, and the D1-D3 pack incl. `SRS.docx`, kept locally per the brief's own "outside the repo" instruction) exist and are accurate as of the submission commit.
